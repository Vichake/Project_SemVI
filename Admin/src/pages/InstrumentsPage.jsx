...
const InstrumentsPage = () => {
  ...
  const filteredInstruments = instruments.filter(
    (instrument) =>
      ...
      instrument.farmer.toLowerCase().includes(searchTerm.toLowerCase()) ||
  ...
  const handleSaveInstrument = (instrumentData) => {
    if (currentInstrument) {
      ...
      const newInstrument = {
        ...instrumentData,
        id: Math.max(0, ...instruments.map((i) => i.id)) + 1,
      };
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-6">
        ...
        <div className="flex mt-4 md:mt-0 space-x-4">
          <div className="relative w-64">
            ...
            />
            <Search size={18} className="absolute top-1/2 right-3 transform -translate-y-1/2 text-gray-600" />
          </div>
          <button
